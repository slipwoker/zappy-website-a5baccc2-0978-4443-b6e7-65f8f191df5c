    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          ...
          formErrorEl.textContent = 'Something went wrong. Please try again later.';
        })
        .finally(function () {
          if (submitBtn) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שאקפה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a5baccc2-0978-4443-b6e7-65f8f191df5c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a5baccc2-0978-4443-b6e7-65f8f191df5c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a5baccc2-0978-4443-b6e7-65f8f191df5c';
